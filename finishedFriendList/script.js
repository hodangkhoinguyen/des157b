Parse.initialize("MPOtrPu61qRg06yjvYvWJhaLDEKLCb2jNMGD64Qw","eoQzZivClc277LZOSQ2kNvNQWhmkh4Wut0RVE3Cg"); //PASTE HERE YOUR Back4App APPLICATION ID AND YOUR JavaScript KEY
...
//         event.preventDefault();
//         addFriendForm.className = "edit-friend-onscreen";
//     });
// }
...
async function setForm(recordId) {
    ...
    try {
        ...
        console.error("Error while fetching friends", e);
    }
}
